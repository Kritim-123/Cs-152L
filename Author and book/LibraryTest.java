public class LibraryTest {
    ...
    public static void main(String[] args) {
        ...
        if( library.getTotalCheckedOut() == 0 ) { tScore++; }
        System.out.println( " - getTotalCheckedOut works for empty library: " + tScore + "/1" );
        score += tScore; tScore = 0;
        ...
        score += tScore; tScore = 0;
        if( library.checkOut( b1 ).equals( "All of our copies are already checked out." )  ) { tScore+=1; }
        System.out.println( " - checkOut works when a book is out of copies: " + tScore + "/1" );
        score += tScore; tScore = 0;
        if( library.checkOut( b3 ).equals( "Book not known in library." ) ) { tScore+=1; }
        ...
        if( library.checkIn( b3 ).equals( "Book not known in library." ) ) { tScore+=1; }
        ...
        if( library.deleteBook( b3 ).equals( "Book not known in library." ) ) { tScore+=1; }
